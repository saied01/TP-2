...
- Si un nodo es el final de una palabra, la palabra que componen los caracteres de los nodos, es una materia como minimo.
-`cantidadDeMaterias` es igual a la cantidad de nodos con finalDePalabra = true.`
* */
